...
- `ValidateRedesignPackageContractBatch` -> `Logs/Verify_RedesignPackageContract_SourcePrefab.log`，覆盖改版包 source prefab 扫描报告边界和 outputFolder 边界复验，return code 0。
