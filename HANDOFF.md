...
- `ValidateRedesignDraftTemplateContractBatch` -> `Logs/Verify_RedesignDraftTemplateContract_DuplicateNewNames.log`，覆盖草稿模板同名旧图 newAssetPath 去重复验，return code 0。
