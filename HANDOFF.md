...
- `Editor/Generation/UIRedesignRequestValidation.cs`：改版 request source prefab、sourcePreviewPath、outputFolder、inputImageFolder 和 referenceImagePaths 边界。
