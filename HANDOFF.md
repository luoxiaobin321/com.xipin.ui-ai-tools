...
- `ValidateMarkdownSectionContractBatch` -> `Logs/Verify_MarkdownSectionContract_DuplicateSections.log`，覆盖重复合法 Markdown section 拒绝复验，return code 0。
