...
- `Editor/Generation/UIRedesignRequestValidation.cs`：改版 request source prefab、outputFolder、inputImageFolder 和 referenceImagePaths 边界。
