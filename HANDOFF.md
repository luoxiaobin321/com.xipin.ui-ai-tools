...
- `ValidateMarkdownSectionContractBatch` -> `Logs/Verify_MarkdownSectionContract_DuplicateMessage.log`，覆盖重复合法 Markdown section 的 duplicate section 报错复验，return code 0。
