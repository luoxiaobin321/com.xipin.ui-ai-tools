...
- `ValidateReportFilesContractBatch` -> `Logs/Verify_ReportFilesContract_CoreHeaders.log`，覆盖核心 CSV 注册表与表头列契约复验，return code 0。
